...
public class UsuarioTest {
    ...
    public Date generarFechas(String stringFecha) throws ParseException{
     ...
     */
    @Test
    public void testExisteNombreViajeTrue() throws ViajeException, FechaException, ParseException, ComentarioException {
        boolean expResult = true;

        SimpleDateFormat sdf = new SimpleDateFormat("dd/MM/yyyy");
        String stringFecha = "01/06/2018";
        Date fechaInicial = sdf.parse(stringFecha);

        instance.altaViaje("Vacaciones", "MADRID", fechaInicial, fechaInicial , "descripcion");
     ...
     */
    @Test
    public void testExisteNombreViajeFalse() throws ViajeException, FechaException, ParseException, ComentarioException {
     ...
     */
    @Test
    public void testBajaViaje() throws ViajeException, FechaException, ParseException, ComentarioException {
        SimpleDateFormat sdf = new SimpleDateFormat("dd/MM/yyyy");
        String stringFecha = "01/06/2018";
        Date fechaInicial = sdf.parse(stringFecha);
        ...
        assertFalse (instance.getListaViajes().contains(new Viaje("Vacaciones")));
    ...
    public void testAltaViajeOK1() throws Exception {
        ...
        instance.altaViaje("Vaca", "MADRID", fechaInicial, fechaInicial, "");
    ...
    public void testAltaViajeOK2() throws Exception {
        ...
        instance.altaViaje("Vacaciones", "MADRID", fechaInicial, fechaInicial, "");
    ...
    public void testAltaViajeOK3() throws Exception {
        ...
        instance.altaViaje("Vacaciones", "MADRID", fechaInicial,fechaInicial, ".    ");
        instance.altaViaje("Vacacion", "MADRID", fechaInicial,fechaInicial, ".    ");
        assert (instance.existeNombreViaje("Vacaciones")
    ...
    public void testAltaViajeErrorDiaIniVacio() throws Exception {
        try {
            SimpleDateFormat sdf = new SimpleDateFormat("dd/MM/yyyy");
            String stringFecha = " /06/2018";
            Date fechaInicial = sdf.parse(stringFecha);
            
            String stringFechaFinal = "10/06/2018";
            Date fechaFinal = sdf.parse(stringFechaFinal);
        
            instance.altaViaje("Vacaciones", "MADRID", fechaInicial,fechaFinal, "descripcion");
            assert (false);
    ...
    public void testAltaViajeErrorMesIniVacio() throws Exception {
        try {
//            SimpleDateFormat sdf = new SimpleDateFormat("dd/MM/yyyy");
//            String stringFecha = "10/ /2018";
//            Date fechaInicial = sdf.parse(stringFecha);
//           
            Date fechaInicial = generarFechas("10/ /2018");
            Date fechaFinal = generarFechas("10/04/2018");
    ...
    public void testAltaViajeErrorAñoIniVacio() throws Exception {
        try {
            Date fechaInicial = generarFechas("10/03/ ");
            Date fechaFinal = generarFechas("10/04/2018");
    ...
    public void testAltaViajeErrorDiaFinVacio() throws Exception {
        try {
             Date fechaInicial = generarFechas("10/04/2018");
            Date fechaFinal = generarFechas(" /04/2018");
    ...
    public void testAltaViajeErrorMesFinVacio() throws Exception {
        try {
             Date fechaInicial = generarFechas("10/04/2018");
            Date fechaFinal = generarFechas("10/ /2018");
    ...
    public void testAltaViajeErrorAñoFinVacio() throws Exception {
        try {
             Date fechaInicial = generarFechas("10/04/2018");
            Date fechaFinal = generarFechas("10/04/ ");
            
            instance.altaViaje("Vacaciones", "MADRID", fe "descripcion");
            assert (false);
        } catch (FechaVaciaException e) {
            assert (true);
        }
