...
public final class Usuario implements Serializable {
    ...
    public void altaViaje(String nombreViaje, String ciudad, Date fechaIni, Date fechaFin, String descripcion)
        throws ViajeException, FechaException, ComentarioException{

        if (existeNombreViaje(nombreViaje)) {
            throw new ViajeExistenteException();
        }
        if(nombreViaje.length()<0){
        ...
        Viaje nuevoViaje = new Viaje(nombreViaje, ciudad, fechaIni, fechaFin, descripcion);
